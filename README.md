...
| `NEXT_PUBLIC_GITHUB_REPO_OWNER` | The owner of the repo that we should pull issues from (e.g. linus in linus/oneblog)                                                                                                                                                                                                                                                                                                               |
| `NEXT_PUBLIC_GITHUB_REPO_NAME`  | The name of the repo that we should pull issues from (e.g. oneblog in linus/oneblog)                                                                                                                                                                                                                                                                                                              |
